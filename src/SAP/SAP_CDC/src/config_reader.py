...
def process_table(table_config: dict, source_dataset: str, target_dataset: str,
    ...
    try:
        ...
        #CUSTOM ENHANCEMENTS for using the partitioning template
        ...
        if "partition_flg" in table_config:
            ...
            partition_flg = "N"
        #END OF CUSTOM ENHANCEMENTS FOR PARTITIONING 
        ...
        if load_frequency == "RUNTIME":
            ...
            #CUSTOM ENHANCEMENTS for using partitioning template - pass the
